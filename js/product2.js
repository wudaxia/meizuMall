...
function openUserInfo(){
    ...
    if(productId!=null&&productId!=undefined&&productId!="")
    {
        ...
        //else{
            ...
            AjaxSubmit("get",JSON.parse(data),basePath+"Goods/getIntegralGoodsMessage",getIntegralGoodsMessage_fun);
        //}
        //获取用户收藏列表页
...
//}
//获取商品详情
function getIntegralGoodsMessage_fun(res){
    console.log(res);
    //商品信息
        ...
        function getJsSdkConfig_fun(shares){
            ...
            wx.ready(function(){
                wx.onMenuShareTimeline({
                    ...
                    desc: "", // 分享描述
                    link: "http://mz.lanpai51.com/web/html/product2.html?productId="+goodsMessage.id, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
    ...
    $(".p-infoPriceR").text(goodsMessage.point);
    $(".p-choseStyleTPriceR").text(goodsMessage.point);
    $(".p-choseStyleTName").text(goodsMessage.title);
    var noChoseStyle='<div class="p-choseStyleColor"> ' +
        '<div class="p-choseStyleColorT">选择商品</div> ' +
    ...
    $(".p-choseStyleTPriceR").attr("data-priceStyle","-1").text(goodsMessage.point);
    $(".p-choseStyleTPriceR").attr("data-priceStyleName",goodsMessage.title);
    $(".p-choseStyleTPriceR").attr("productId",goodsMessage.id).attr("productName",goodsMessage.title);
    //$(".p-choseStyleTName").text(goodsMessage.tags);
    //为1是有规格，-1是没有规格
    //$(".p-choseStyleTPriceR").text(res.backData.price).attr("data-isParameter",isParameter).attr("data-isActivity",res.backData.isActivity).attr("productId",goodsMessage.id).attr("productName",goodsMessage.title);
    //$(".p-infoPriceR").text(res.backData.price);
    ////是否活动商品
    ...
    //        {
    //            $(".p-choseStyleTImg").attr("src",imgPath+res.backData.imgUrl);
    //        }
    //        //抢购价
    ...
    //                        {
    //                            choseStyleLis+= '<span data-first="1" data-imgUrl="'+imgPath+styleColorSpan.img_url+'" class="p-styleColor" data-parentId="'+(i+1)+'"   val="'+styleColorSpan.id+'">'+styleColorSpan.name+'</span> ';
    //                        }
    //                        else{
    //                            console.log(33);
    //                            console.log(goodsMessage.img_url);
    //                            choseStyleLis+= '<span data-first="1" data-imgUrl="'+imgPath+goodsMessage.img_url+'" class="p-styleColor" data-parentId="'+(i+1)+'"   val="'+styleColorSpan.id+'">'+styleColorSpan.name+'</span> ';
    //                        }
    //                    }
    //                    else{
    //                        if(styleColorSpan.img_url!=null&&styleColorSpan.img_url!=undefined&&styleColorSpan.img_url!="")
    ...
    //                $(this).removeClass('p-styleColorChose');
    //                $(".p-choseStyleTPriceR").removeAttr("data-priceStyle");
    //                $(".p-choseStyleTImg").attr("src",imgPath+goodsMessage.img_url);
    //            }else{
    //                $(this).siblings().removeClass('p-styleColorChose');
    //                $(this).addClass('p-styleColorChose');
    //                if($(this).attr("data-first")=="1")
    //                {
    //                    if($(this).attr("data-imgUrl")!=null&&$(this).attr("data-imgUrl")!=undefined&&$(this).attr("data-imgUrl")!="")
    //                    {
    //                        $(".p-choseStyleTImg").attr("src",$(this).attr("data-imgUrl"));
    //                    }
    //                }
    //            }
...
function chosePrice(price){
    var prices=price.join("_");
    $.each(sku_list,function(j,chosePriceF){
        if(chosePriceF.assembly==prices)
        {
            $(".p-choseStyleTPriceR").text(chosePriceF.price).attr("data-priceStyle",chosePriceF.assembly);
            $(".p-choseStyleTPriceR").text(chosePriceF.price).attr("data-priceStyleName",chosePriceF.assembly_info);
