...
function getArticleList(){
    var data='{"index":'+pageIndex+',"page_num":'+pageCount+'}';
    openGetMore();
    AjaxSubmit("get",JSON.parse(data),basePath+"Article/getArticleList",getArticleList_fun);
}
//得到魅族信息列表
function getArticleList_fun(res){
    console.log(res);
